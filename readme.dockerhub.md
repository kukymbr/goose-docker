...
docker run --rm -v ./migrations:/migrations \
     ...
     kukymbr/goose-docker-cmd:v3.27.1 \
...
services:
  ...
  migrations:
    image: kukymbr/goose-docker:3.27.1
    environment:
...
```Dockerfile
FROM kukymbr/goose-docker:3.27.1
